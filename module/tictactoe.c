 ...
 *
 *  tictactoe.c: implements a virtual character device that interacts with the file in a userspace
*/
...
#define MODULE_NAME "tictactoe"	/* Dev name as it appears in /proc/devices*/
#define DRIVER_AUTHOR "Hugues Nelson Iradukunda"
#define DRIVER_DESCRIPTION "Tictactoe Character device driver"
